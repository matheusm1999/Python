#Usando o algorítmo Support Vector Machine para saber se uma determinada pessoa pagou ou não um empréstimo
...
classificador = SVC(kernel = 'rbf',random_state=1,C = 3) #com o kernel  = linear, obtive o resultado de 95%, com o poly, obtive uma taxa de 97.6%, com sigmoid a taxa de acerto foi de 83%, já com o rbf a taxa de acerto foi de 99.2%.
#Caso o C seja >=3 , a taxa de acerto, com o uso do kernel = 'rbf', será de 99.6% (ou seja, teve um aumento de 0.4%)
